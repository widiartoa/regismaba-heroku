...
INSERT INTO `mahasiswa` (`username`, `npm`, `uid_sso`, `program_studi_id`, `no_seleksi`, `jadwal_registrasi_id`, `jadwal_tes_kesehatan_id`, `jadwal_ept_id`, `created_by`, `created_at`, `tahun_ajaran_id`, `biaya_bop_fix`) VALUES
('anindhita.yanti', '1234567896', 'anindhita.yanti', 7, '123456', 3, 1, 2, 'redita.arifin', '2017-04-26 00:38:51', 3, 0),
('arief.nugraha', '1234567897', 'arief.nugraha', 15, '123457', 4, 1, 3, 'redita.arifin', '2017-04-26 00:38:51', 3, 0),
('benathavia.saladdin', '1234567890', 'benathavia.saladdin', 3, '123450', 1, 2, 3, 'redita.arifin', '2017-05-10 08:00:00', 3, 0),
('dwi.arief', '1234567892', 'dwi.arief', 3, '123452', 3, 2, 1, 'redita.arifin', '2017-05-10 08:00:00', 3, 0),
('hardyn.adiyoso', '1234567891', 'hardyn.adiyoso', 4, '123451', 1, 2, 3, 'redita.arifin', '2017-05-10 08:00:00', 3, 0),
('lia.julia', '1234567898', 'lia.julia', 6, '123458', 3, 1, 4, 'redita.arifin', '2017-04-26 00:38:51', 1, 0),
('lia.naren', '1234567893', 'lia.naren', 4, '123453', 3, 2, 1, 'redita.arifin', '2017-05-10 08:00:00', 1, 0),
('liyanti.saraswati', '1234567899', 'liyanti.saraswati', 7, '123459', 1, 2, 3, 'redita.arifin', '2017-04-26 00:38:51', 1, 0),
('naren.jul', '1234567894', 'naren.jul', 5, '123454', 1, 2, 3, 'redita.arifin', '2017-05-10 08:00:00', 2, 0),
('widiarliyanti', '1234567895', 'widiarliyanti', 6, '123455', 3, 2, 1, 'redita.arifin', '2017-05-10 08:00:00', 2, 0);
...
INSERT INTO `pengajuan_skema_pembayaran` (`pengajuan_id`, `golongan_id`, `username`, `gaji_pribadi`, `gaji_wali1`, `gaji_wali2`, `nilai_tagihan_air`, `nilai_tagihan_listrik`, `nilai_tagihan_telepon`, `surat_keterangan_rtrw`, `foto_rumah`, `slip_gaji_pribadi`, `slip_gaji_wali1`, `slip_gaji_wali2`, `tagihan_air`, `tagihan_listrik`, `tagihan_telepon`, `status_pengajuan`, `komentar`, `created_by`, `created_at`, `updated_by`, `updated_at`, `uang_pangkal`, `jumlah_biaya_semester`) VALUES
(1, 2, 'benathavia.saladdin', 5000000, 3000000, 1000000, 400000, 100000, 0, 'fr1.jpg', 'sgp1.jpg', 'sgw11.jpg', 'sgw21.jpg', NULL, 'ta1.jpg', 'tl1.jpg', 'tt1.jpg', 'Unverified', NULL, 'benathavia.saladdin', '2017-05-10 08:00:00', 'benathavia.saladdin', '2017-05-05 23:10:14', 0, 3000000),
(2, 3, 'hardyn.adiyoso', 0, 5000000, 5000000, 300000, 100000, 100000, 'skrtrw2.jpg', 'fr2.jpg', 'sgp2.jpg', 'sgw12.jpg', 'sgw22.jpg', 'ta2.jpg', 'tl2.jpg', 'tt2.jpg', 'Unverified', NULL, 'hardyn.adiyoso', '2017-05-10 01:00:00', 'hardyn.adiyoso', '2017-05-05 23:10:35', 7500000, 7500000),
(3, 1, 'dwi.arief', 0, 0, 0, 0, 0, 0, NULL, '-', NULL, NULL, NULL, NULL, NULL, NULL, 'Unverified', NULL, 'dwi.arief', '2017-05-10 01:00:00', 'dwi.arief', '2017-05-10 01:00:00', 0, 0);
...
CREATE TABLE `skema_pembayaran` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tingkat_role_id` int(11) NOT NULL,
  `jumlah_biaya_minimal` int(11) NOT NULL,
  `jumlah_biaya_maksimal` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `skema_pembayaran` (`golongan_id`, `jumlah_biaya_ipa`, `uang_pangkal_ipa`, `jumlah_biaya_ips`, `uang_pangkal_ips`, `jumlah_biaya_ik`, `uang_pangkal_ik`, `created_by`, `created_at`, `updated_by`, `updated_at`, `tingkat_role_id`, `jumlah_biaya_minimal`, `jumlah_biaya_maksimal`) VALUES
(1, 7000000, 0, 5000000, 0, 10000000, 0, 'irsyadillah.nuralifa', '2017-05-10 08:00:00', 'irsyadillah.nuralifa', '2017-05-05 23:07:01', 1, 0, 5000000),
(2, 9500000, 3000000, 7500000, 2500000, 10000000, 5000000, 'irsyadillah.nuralifa', '2017-05-10 08:10:00', 'irsyadillah.nuralifa', '2017-05-05 23:07:38', 1, 5000000, 10000000),
(3, 12500000, 30000000, 9500000, 5000000, 15000000, 7500000, 'irsyadillah.nuralifa', '2017-05-10 08:20:00', 'irsyadillah.nuralifa', '2017-05-05 23:07:51', 2, 10000000, 15000000);
